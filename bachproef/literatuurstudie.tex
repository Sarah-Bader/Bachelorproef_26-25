...
\subsection{Modernisatie van legacy-systemen}

Organisaties hebben verschillende mogelijkheden om legacy-systemen te moderniseren \textcite{sneed_verhoef_2019}. Ze hebben bijvoorbeeld de mogelijkheid tot conversie, herontwikkeling of herimplementatie van hun bestaande systemen. De studie concludeerd dat automatische conversie van bestaande systemen niet altijd succesvol is, vooral wanneer programma's sterk geïntegreerd zijn met de bestaande architecturen. Hierdoor kan herimplementatie een realistischer alternatief zijn. 
...
Chevrotain is een krachtige JavaScript-parsing library die ontworpen is om efficiënte parsers te bouwen. In tegenstelling tot klassieke generatoren genereert Chevrotain geen externe code, maar laat je grammatica’s volledig als gewone JavaScript-broncode definiëren \autocite{chevrotain_2018}. 
