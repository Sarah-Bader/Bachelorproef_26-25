...
Tape/Z is een toolkit die werd ontworpen voor het analyseren en visualiseren van HLASM-code binnen mainframe-omgevingen. Het doel van deze tool is om code overzichtelijk in kaart te brengen door middel van het parsen van instructies en het automatisch opbouwen van control-flow diagrammen die de structuur van het programma weergeven \autocite{gupta_2025}.
