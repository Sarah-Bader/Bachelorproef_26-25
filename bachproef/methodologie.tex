...
Het resultaat van deze fase is Hoofdstuk \ref{ch:cfvisualisatie} (Control-flow visualisatie), waarin een duidelijke afbakening en functionele eisen voor de verdere ontwikkeling staan beschreven. 
...
In de evaluatiefase werd onderzocht of de proof-of-concept effectief de HLASM-control flow correct weergeeft.

Om de correctheid te kunnen meten, werden volgende criteria vastgelegd:

\begin{itemize}
    \item het ... van start- en eindpunten,
    \item het ... alle mogelijke vertakkingen,
\end{itemize}

Het resultaat van deze fase wordt besproken in Hoofdstuk \ref{ch:conclusie} (Conclusie).
