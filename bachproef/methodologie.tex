...
Het resultaat van deze fase is Hoofdstuk 2 (Literatuurstudie), waarin de deelvragen worden beantwoord en de noodzaak van een visualisatietool wordt onderbouwd.

\subsection{Fase 2: Technische analyse van HLASM}
...
\subsection{Fase 3: Requirementsanalyse}
...
Het resultaat van deze fase is een duidelijke afbakening en functionele eisen voor de verdere ontwikkeling en evaluatie. 
...
Het resultaat van deze fase is Hoofdstuk 6 (Proof-of-Concept), waarin het ontwerp en de implementatie wordt weergegeven. 
...
Het resultaat van deze fase wordt besproken in Hoofdstuk 6 (Proof-of-Concept) en geïnterpreteerd in Hoofdstuk 7 (Conclusie).
