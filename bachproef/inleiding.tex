...
In Hoofdstuk \ref{ch:literatuurstudie} (Literatuurstudie) worden de deelvragen uit het oplossingsdomein en het probleemdomein onderzocht aan de hand van bestaande onderzoeken en literatuur. Hiermee wordt een beter zicht gecreëerd op het probleem en de oplossing om zo gericht mogelijk te werken. 

In Hoofdstuk \ref{ch:methodologie} (Methodologie) wordt toegelicht welke onderzoekstechnieken worden gebruikt.

In Hoofdstuk \ref{ch:hlasmanalyse} (HLASM-analyse) wordt gekeken naar Assembler, hoe de programmeertaal is opgebouwd en welke elementen de structuur van het programma vastleggen. 

In Hoofdstuk \ref{ch:cfvisualisatie} (Control-flow visualisatie) wordt bekeken hoe de Assembler-structuur kan worden omgezet naar Mermaid.js-elementen. Er wordt onderzocht hoe dit visueel logisch kan worden gerepresenteerd. 

In Hoofdstuk \ref{ch:poc} (Proof-of-Concept) wordt de PoC uitgewerkt en daarna geëvalueerd aan de hand van testen. 

In Hoofdstuk \ref{ch:conclusie} (Conclusie) wordt gekeken naar het resultaat van de evaluatie en naar de literatuurstudie om een antwoord te formuleren op de onderzoeksvragen.  
